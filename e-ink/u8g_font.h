...
void 		u8g2_SetFontMode(u8g2_t *u8g2, uint8_t is_transparent, COLOR bg_color);
void		u8g2_SetFontScale(u8g2_t *u8g2, uint8_t scale);
uint8_t		u8g2_GetFontScale(u8g2_t *u8g2);
uint8_t		u8g2_IsGlyph(u8g2_t *u8g2, uint16_t requested_encoding);
int8_t		u8g2_GetGlyphWidth(u8g2_t *u8g2, uint16_t requested_encoding);

u8g2_uint_t u8g2_DrawStr(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, const char *str, COLOR color);
u8g2_uint_t u8g2_DrawUTF8(u8g2_t *u8g2, u8g2_uint_t x, u8g2_uint_t y, const char *str, COLOR color);

u8g2_uint_t u8g2_allocateBitmap(u8g2_t *u8g2, uint8_t** buff, const char *str);
u8g2_uint_t u8g2_StrToBitmap(u8g2_t *u8g2, uint8_t* buff, uint16_t width, const char *str, BM_ALIGN align);
...
class u8gFont {
	public:
		...
		void		setFontMode(uint8_t is_transparent, COLOR bg_color)
		...
		u8g2_uint_t drawStr(u8g2_uint_t x, u8g2_uint_t y, const char *str, COLOR color)
															{ return u8g2_DrawStr(&u8g, x, y, str, color);					}
		u8g2_uint_t drawUTF8(u8g2_uint_t x, u8g2_uint_t y, const char *str, COLOR color)
		...
		uint8_t		getMaxCharHeight(void)					{ return u8g2_GetMaxCharHeight(&u8g);							}
		int8_t		getFontHeight(void)						{ return u8g2_GetMaxCharHeight(&u8g) - u8g2_GetDescent(&u8g); 	}
		int8_t		getFontDescent(void)					{ return u8g2_GetFontDescent(&u8g);								}	// Negative value
